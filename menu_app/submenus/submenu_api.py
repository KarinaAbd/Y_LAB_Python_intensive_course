...
def patch_submenu(submenu_id: str,
                  ...
                  db: Session = Depends(get_db)):
    current_submenu = submenu_crud.get_submenu_by_id(db, submenu_id=submenu_id)
    updated_title = submenu_crud.get_submenu_by_title(
        db, submenu_title=updated_submenu.title
    )
    ...
    return submenu_crud.update_submenu(db=db,
